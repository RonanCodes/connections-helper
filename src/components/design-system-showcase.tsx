...
export default function DesignSystemShowcase() {
  const search = useSearch({ from: '/design-system' })
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-5xl mx-auto px-5 sm:px-6 md:px-8 py-6 md:py-10 space-y-10">
        <header className="space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Live showcase of tokens and primitives. Dev-only route, not
        ...
        <Section
          title="Inputs"
          description="Same radius and focus treatment as Button."
        >
