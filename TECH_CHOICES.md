...
**Tradeoff:** 10ms CPU limit on the free plan (fine for this workload), and Node API compatibility is partial — stick to the Workers runtime APIs.
...
- Vitest shares Vite's transform pipeline — no separate Babel/ts-jest config
